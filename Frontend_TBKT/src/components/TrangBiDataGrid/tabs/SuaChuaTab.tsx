// ============================================================
// Component Tab: SuaChuaTab
// Displays repair log history + DynamicFields for the equipment.
// Fields are loaded via FieldSet filtered by loai_nghiep_vu = "sua_chua".
// ============================================================
...
const DEFAULT_SET_COLORS = ['#f59e0b', '#d97706', '#b45309', '#92400e', '#78350f'];
...
const SuaChuaTab: React.FC<LogTabProps> = ({
    trangBiId,
    trangBiName,
    fieldSets,
    formData,
    ...
    useEffect(() => {
        if (!trangBiId) return;
        setLoading(true);
        getLogHistoryByTrangBi({ idTrangBi: trangBiId, logType: LogType.SuaChua, limit: 20 })
            .then(setItems)
                ...
                <Box sx={{ mb: 1.5 }}>
                    ...
                    >
                        ...
                        <Typography variant="body2" fontWeight={700} sx={{ flex: 1 }}>
                            Biểu mẫu sửa chữa ({fieldSets.length} bộ dữ liệu)
                        </Typography>
                        <Chip
