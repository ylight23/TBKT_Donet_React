// ============================================================
// Component Tab: DieuDongTab
// Displays dispatch/movement log history + DynamicFields for the equipment.
// Fields are loaded via FieldSet filtered by loai_nghiep_vu = "dieu_dong".
// ============================================================
...
const DEFAULT_SET_COLORS = ['#06b6d4', '#0891b2', '#0e7490', '#155e75', '#164e63'];
...
const DieuDongTab: React.FC<LogTabProps> = ({
    trangBiId,
    trangBiName,
    fieldSets,
    formData,
    ...
    useEffect(() => {
        if (!trangBiId) return;
        setLoading(true);
        getLogHistoryByTrangBi({ idTrangBi: trangBiId, logType: LogType.DieuDong, limit: 20 })
            .then(setItems)
                ...
                <Box sx={{ mb: 1.5 }}>
                    ...
                    >
                        ...
                        <Typography variant="body2" fontWeight={700} sx={{ flex: 1 }}>
                            Biểu mẫu điều động ({fieldSets.length} bộ dữ liệu)
                        </Typography>
                        <Chip
