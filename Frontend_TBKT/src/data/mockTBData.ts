...
export const mockChuyenCap: IChuyenCap[] = []; /* [
    { id: 'CC-001', maTrangBi: 'TB-002', tenTrangBi: 'Máy vô tuyến điện VRU-612', donVi: 'Lữ đoàn 2', capCu: ChatLuong.Tot, capMoi: ChatLuong.Kha, ngayCapNhat: '2024-01-05', lyReason: 'Sử dụng cường độ cao', nguoiXacNhan: 'Lê Văn B' },
]; */

export const mockDieuDong: IDieuDong[] = []; /* [
    { id: 'DD-001', maTrangBi: 'TB-001', tenTrangBi: 'Máy vô tuyến điện VRU-611', donViCu: 'Lữ đoàn 1', donViMoi: 'Lữ đoàn 2', ngayDieuDong: '2024-03-01', lyReason: 'Tăng cường lực lượng', nguoiDuyet: 'Đại tá Nguyễn Văn Hùng', trangThai: 'Đã duyệt' },
    { id: 'DD-002', maTrangBi: 'TB-101', tenTrangBi: 'Đài Radar 36D6', donViCu: 'Trung đoàn 291', donViMoi: 'Kho 864', ngayDieuDong: '2024-03-05', lyReason: 'Sửa chữa lớn', nguoiDuyet: 'Thiếu tướng Trần Văn Minh', trangThai: 'Chờ duyệt' },
]; */
