        ...
        <Box sx={{ height: 320 }}>
          <LazyDataGrid
            ...
            rowActions={{
              ...
              disabled: {
                view: (row) => isRowActionDisabled('view', row as Record<string, unknown>),
                edit: (row) => isRowActionDisabled('edit', row as Record<string, unknown>),
                delete: (row) => isRowActionDisabled('delete', row as Record<string, unknown>),
                print: (row) => isRowActionDisabled('print', row as Record<string, unknown>),
                export: (row) => isRowActionDisabled('export', row as Record<string, unknown>),
              },
            }}
            loading={loadingRows}
