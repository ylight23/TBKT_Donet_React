 ...
 * ¦  Version : 2.0.0                                                   ¦
 * ¦  Chu?n   : WCAG AA | Material Design 3 | Quy t?c 60-30-10         ¦
 * +--------------------------------------------------------------------+
 *
 * +-----------------------------------------------------------------+
 * ¦  QUY T?C 60 - 30 - 10 (áp d?ng cho giao di?n quân s?)          ¦
 * ¦                                                                   ¦
 * ¦  60% ? Dominant / N?n ch? d?o                                    ¦
 * ¦        Vietnam Army Olive (OD Green) – quân ph?c QÐNDVN          ¦
 * ¦        Light: #F0F2F5 (bg) + #FFFFFF (card)                       ¦
 * ¦        Dark : #0C1203 (bg) + #152008 (sidebar) + #1A280A (card)  ¦
 * ¦                                                                   ¦
 * ¦  30% ? Secondary / H? tr? c?u trúc                               ¦
 * ¦        Tactical Navy + Steel Gray                                 ¦
 * ¦        Dùng cho: card border, header, icon, typography ph?       ¦
 * ¦                                                                   ¦
 * ¦  10% ? Accent / Ði?m nh?n hành d?ng                              ¦
...
/**
 * ?? Vietnam Army Olive — Màu quân ph?c Quân d?i Nhân dân Vi?t Nam (dominant 60%)
 * Tâm lý: Kiên d?nh – T? qu?c – R?ng núi – S?c m?nh n?i tâm
 * HEX base: #5A7A28  |  RGB: (90, 122, 40)
 * Dùng: Sidebar, Topbar, DataGrid header, Page background family
 * Ref: Quân ph?c xanh d?ng ph?c QÐNDVN (Olive Drab / OD Green)
 */
...
/** @deprecated Dùng armyOlive thay th?. Gi? l?i d? tuong thích code cu. */
export const militaryOlive = armyOlive;

/**
 * ?? Deep Army Green — Màu k? thu?t quân s?
 * Tâm lý: Ho?t d?ng – S?n sàng chi?n d?u – Thiên nhiên – Kiên nh?n
...
/**
 * ?? Tactical Green — Màu xanh r?ng tác chi?n
 * Tâm lý: Chi?n lu?c – Chính xác – Sâu s?c – Khoa h?c
 * RGB base: rgb(46, 77, 49)
...
/** @deprecated Dùng tacticalGreen thay th?. Gi? l?i d? tuong thích code cu. */
...
/**
 * ?? Steel Gray — Thép quân s?
 * Tâm lý: L?nh lùng – K? lu?t – B?n b? – Co khí
...
/**
 * ?? Gunmetal — Nòng súng / V? thi?t giáp
 * Tâm lý: Bí ?n – Công nghi?p – M?nh m?
...
/**
 * ? Military Silver — Huy hi?u / Phù hi?u quân hàm
 * Tâm lý: Danh d? – Thành tích – Tinh t?
 * RGB base: rgb(119, 141, 169)
 * Dùng: Badge h?ng nh?t, Accent icon trên dark bg
 */
...
/**
 * ?? Military Gold — Phù hi?u / Huân chuong
 * Tâm lý: Thành tích – Uy danh – Giá tr? cao – C?nh báo quan tr?ng
...
// -------------------------------------------------------------------
//  SECTION 3 — STATUS COLORS (Chu?n quân s? – Operational Status)
// -------------------------------------------------------------------

export const statusColors = {
  operational: {
    main: '#2E7D32',  // rgb(46,125,50)  – Xanh r?ng tr?m
    light: '#4CAF50',
    dark: '#1B5E20',
    bg: '#E8F5E9',
    bgDark: '#0F2D10',
  ...
  maintenance: {
    main: '#E65100',  // rgb(230,81,0)   – Cam tr?m
    light: '#FF8C42',
    dark: '#BF360C',
    bg: '#FBE9E7',
    bgDark: '#2D1300',
  ...
  critical: {
    main: '#B71C1C',  // rgb(183,28,28)  – Ð? huy?t d?m
    light: '#EF5350',
    dark: '#7F0000',
    bg: '#FFEBEE',
    bgDark: '#2D0000',
  ...
  standby: {
    main: '#37474F',  // rgb(55,71,79)   – Xám xanh l?nh
    light: '#607D8B',
    dark: '#263238',
    bg: '#ECEFF1',
    bgDark: '#0E1517',
    label: 'D? phòng / Niêm c?t',
  },
  repairing: {
    main: '#ED6C02',  // rgb(237,108,2)  – Cam v?a
    light: '#FF9800',
    dark: '#C43E00',
    bg: '#FFF3E0',
    bgDark: '#2A1500',
...
export const militaryColors = {
  ...
  info: deepArmyGreen[400], // Technical Green thay vì Blue
...
//  C? th? hóa 60-30-10 cho t?ng element giao di?n
// -------------------------------------------------------------------

/**
 * --- GRADIENT GREEN (30% Secondary Rule) -------------------------------------
 * 2 màu stop duy nh?t — 90deg — green base thu?n
 * Light: xanh sáng  ? xanh d?m
 * Dark : xanh d?m   ? xanh r?t t?i
 */
export const gradientGreen = {
  ...
  lightBtn: 'linear-gradient(90deg, #5daf60ff, #82ac84ff)',   // medium ? forest
  ...
  darkBtn: 'linear-gradient(90deg, #388E3C, #112e14ff)',   // forest ? deep
  darkBtnHov: 'linear-gradient(90deg, #2E7D32, #133b18ff)',   // forest ? very dark
  darkHeader: 'linear-gradient(90deg, #1b4d1dff, #071A0A)',   // forest ? near-black
...
// -------------------------------------------------------------------
//  SECTION 6 — LEGACY TOKEN MAP (tuong thích code cu)
// -------------------------------------------------------------------
