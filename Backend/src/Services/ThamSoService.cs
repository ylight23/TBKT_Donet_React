    ...
    ProtoSchemaDiscoveryService protoSchemaDiscoveryService) : ThamSoService.ThamSoServiceBase
{
    ...
    public override Task<GetListDynamicFieldsResponse> GetListDynamicFields(
        ...
        dynamicFieldService.GetListDynamicFieldsAsync(request, context);
    ...
    [Authorize]
    public override Task<GetFieldSetsByKeyResponse> GetFieldSetsByKey(
        GetFieldSetsByKeyRequest request, ServerCallContext context) =>
    ...
    [Authorize]
    public override Task<GetRuntimeFormSchemaResponse> GetRuntimeFormSchema(
        GetRuntimeFormSchemaRequest request, ServerCallContext context) =>
        formConfigService.GetRuntimeFormSchemaAsync(request, context);
