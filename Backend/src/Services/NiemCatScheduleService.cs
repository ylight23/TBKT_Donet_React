...
[Authorize]
public sealed class NiemCatScheduleServiceImpl(
    ILogger<NiemCatScheduleServiceImpl> logger)
    : NiemCatScheduleService.NiemCatScheduleServiceBase
{
    ...
    [Authorize]
    public override async Task<GetListNiemCatScheduleResponse> GetListNiemCatSchedule(
        GetListNiemCatScheduleRequest request, ServerCallContext context)
    {
        ...
        try
        {
            ...
            if (coll == null)
            {
                ...
                response.Message = "MongoDB collection NiemCatSchedule is unavailable.";
                return response;
            }
        ...
        {
            logger.LogError(ex, "GetListNiemCatSchedule error");
            response.Success = false;
    ...
    [Authorize]
    public override async Task<GetNiemCatScheduleResponse> GetNiemCatSchedule(
        GetNiemCatScheduleRequest request, ServerCallContext context)
    {
        ...
        try
        {
            ...
            {
                response.Success = false;
                response.Message = "Khong tim thay lich niem cat.";
                return response;
            }
        ...
        {
            logger.LogError(ex, "GetNiemCatSchedule error: {Id}", request.Id);
            response.Success = false;
            response.Message = ex.Message;
            return response;
        }
    ...
    [Authorize]
    public override async Task<SaveNiemCatScheduleResponse> SaveNiemCatSchedule(
        SaveNiemCatScheduleRequest request, ServerCallContext context)
    {
        ...
        try
        {
            ...
            var update = Builders<BsonDocument>.Update
                .Set("TenNiemCat", item.TenNiemCat)
                .Set("CanCu", item.CanCu)
                .Set("LoaiDeNghi", item.LoaiDeNghi)
                .Set("LoaiNiemCat", item.LoaiNiemCat)
                .Set("DonViThucHien", item.DonViThucHien)
                .Set("NguoiThucHien", item.NguoiThucHien)
                .Set("NgayNiemCat", ToBsonDateOrNull(item.NgayNiemCat))
                .Set("KetQuaThucHien", item.KetQuaThucHien)
        ...
        {
            logger.LogError(ex, "SaveNiemCatSchedule error: {Id}", request.Item?.Id);
            response.Success = false;
            response.Message = ex.Message;
            return response;
        }
    ...
    [Authorize]
    public override async Task<DeleteBaseResponse> DeleteNiemCatSchedule(
        DeleteNiemCatScheduleRequest request, ServerCallContext context)
    {
        ...
        {
            logger.LogError(ex, "DeleteNiemCatSchedule error: {Id}", request.Id);
            response.Success = false;
            response.Message = ex.Message;
            return response;
        }
    ...
    [Authorize]
    public override async Task<GetListNiemCatScheduleByTrangBiResponse> GetListNiemCatScheduleByTrangBi(
        GetListNiemCatScheduleByTrangBiRequest request, ServerCallContext context)
    {
        ...
        {
            logger.LogError(ex, "GetListNiemCatScheduleByTrangBi error: {IdTrangBi}", request.IdTrangBi);
            response.Success = false;
            response.Message = ex.Message;
            return response;
        }
    ...
    private static FilterDefinition<BsonDocument> BuildListFilter(GetListNiemCatScheduleRequest request, ServerCallContext context)
    {
        ...
        if (!string.IsNullOrWhiteSpace(request.SearchText))
        {
            ...
            filters.Add(fb.Or(
                fb.Regex("TenNiemCat", regex),
                fb.Regex("CanCu", regex),
                fb.Regex("LoaiDeNghi", regex),
                fb.Regex("LoaiNiemCat", regex),
                fb.Regex("DonViThucHien", regex),
                fb.Regex("NguoiThucHien", regex),
        ...
        if (fromDate.HasValue)
            filters.Add(fb.Gte("NgayNiemCat", fromDate.Value));
        if (toDate.HasValue)
            filters.Add(fb.Lte("NgayNiemCat", toDate.Value));
    ...
    private async Task ValidateTrangBiRefsAsync(IEnumerable<NiemCatScheduleTrangBiItem> items, CancellationToken cancellationToken)
    {
    ...
    private static NiemCatScheduleGridItem ToGridItem(BsonDocument doc)
    {
        var item = new NiemCatScheduleGridItem
        {
            Id = doc.IdString(),
            TenNiemCat = doc.StringOr("TenNiemCat"),
            CanCu = doc.StringOr("CanCu"),
            LoaiDeNghi = doc.StringOr("LoaiDeNghi"),
            LoaiNiemCat = doc.StringOr("LoaiNiemCat"),
            DonViThucHien = doc.StringOr("DonViThucHien"),
            NguoiThucHien = doc.StringOr("NguoiThucHien"),
            KetQuaThucHien = doc.StringOr("KetQuaThucHien"),
            SoTrangBi = doc.ArrayOr("DsTrangBi").Count,
            NguoiSua = doc.StringOr("NguoiSua"),
        };

        if (doc.TryGetValue("NgayNiemCat", out var n) && n.IsBsonDateTime)
            item.NgayNiemCat = Timestamp.FromDateTime(n.AsBsonDateTime.ToUniversalTime());
    ...
    private static NiemCatScheduleItem ToItem(BsonDocument doc)
    {
        var item = new NiemCatScheduleItem
        {
            Id = doc.IdString(),
            TenNiemCat = doc.StringOr("TenNiemCat"),
            CanCu = doc.StringOr("CanCu"),
        ...
        if (doc.TryGetValue("NgayNiemCat", out var ndn) && ndn.IsBsonDateTime)
            item.NgayNiemCat = Timestamp.FromDateTime(ndn.AsBsonDateTime.ToUniversalTime());
        ...
        if (doc.TryGetValue("DsTrangBi", out var members) && members.IsBsonArray)
        {
            ...
            {
                var row = new NiemCatScheduleTrangBiItem
                {
        ...
        int version)
    {
        return new BsonDocument
        {
            ...
            ["NgayNiemCat"] = ToBsonDateOrNull(item.NgayNiemCat),
    ...
    private static BsonArray MapTrangBiItems(IEnumerable<NiemCatScheduleTrangBiItem> items)
    {
