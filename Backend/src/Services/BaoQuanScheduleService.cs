...
[Authorize]
public sealed class BaoQuanScheduleServiceImpl(
    ILogger<BaoQuanScheduleServiceImpl> logger)
    : BaoQuanScheduleService.BaoQuanScheduleServiceBase
{
    ...
    [Authorize]
    public override async Task<GetListBaoQuanScheduleResponse> GetListBaoQuanSchedule(
        GetListBaoQuanScheduleRequest request, ServerCallContext context)
    {
        ...
        try
        {
            ...
            if (coll == null)
            {
                ...
                response.Message = "MongoDB collection BaoQuanSchedule is unavailable.";
                return response;
            }
        ...
        {
            logger.LogError(ex, "GetListBaoQuanSchedule error");
            response.Success = false;
    ...
    [Authorize]
    public override async Task<GetBaoQuanScheduleResponse> GetBaoQuanSchedule(
        GetBaoQuanScheduleRequest request, ServerCallContext context)
    {
        ...
        try
        {
            ...
            {
                response.Success = false;
                response.Message = "Khong tim thay lich bao quan.";
                return response;
            }
        ...
        {
            logger.LogError(ex, "GetBaoQuanSchedule error: {Id}", request.Id);
            response.Success = false;
            response.Message = ex.Message;
            return response;
        }
    ...
    [Authorize]
    public override async Task<SaveBaoQuanScheduleResponse> SaveBaoQuanSchedule(
        SaveBaoQuanScheduleRequest request, ServerCallContext context)
    {
        ...
        try
        {
            ...
            var update = Builders<BsonDocument>.Update
                .Set("TenLichBaoQuan", item.TenLichBaoQuan)
        ...
        {
            logger.LogError(ex, "SaveBaoQuanSchedule error: {Id}", request.Item?.Id);
            response.Success = false;
            response.Message = ex.Message;
            return response;
        }
    ...
    [Authorize]
    public override async Task<DeleteBaseResponse> DeleteBaoQuanSchedule(
        DeleteBaoQuanScheduleRequest request, ServerCallContext context)
    {
        ...
        {
            logger.LogError(ex, "DeleteBaoQuanSchedule error: {Id}", request.Id);
            response.Success = false;
            response.Message = ex.Message;
            return response;
        }
    ...
    [Authorize]
    public override async Task<GetListBaoQuanScheduleByTrangBiResponse> GetListBaoQuanScheduleByTrangBi(
        GetListBaoQuanScheduleByTrangBiRequest request, ServerCallContext context)
    {
        ...
        {
            logger.LogError(ex, "GetListBaoQuanScheduleByTrangBi error: {IdTrangBi}", request.IdTrangBi);
            response.Success = false;
            response.Message = ex.Message;
            return response;
        }
    ...
    private static FilterDefinition<BsonDocument> BuildListFilter(GetListBaoQuanScheduleRequest request, ServerCallContext context)
    {
        ...
        if (!string.IsNullOrWhiteSpace(request.IdDonVi))
            filters.Add(fb.Eq("IdDonVi", request.IdDonVi));
    ...
    private async Task ValidateTrangBiRefsAsync(IEnumerable<BaoQuanScheduleTrangBiItem> items, CancellationToken cancellationToken)
    {
    ...
    private static BaoQuanScheduleGridItem ToGridItem(BsonDocument doc)
    {
        var item = new BaoQuanScheduleGridItem
        {
            Id = doc.IdString(),
            TenLichBaoQuan = doc.StringOr("TenLichBaoQuan"),
    ...
    private static BaoQuanScheduleItem ToItem(BsonDocument doc)
    {
        var item = new BaoQuanScheduleItem
        {
            Id = doc.IdString(),
            TenLichBaoQuan = doc.StringOr("TenLichBaoQuan"),
            CanCu = doc.StringOr("CanCu"),
        ...
        if (doc.TryGetValue("DsTrangBi", out var members) && members.IsBsonArray)
        {
            ...
            {
                var row = new BaoQuanScheduleTrangBiItem
                {
    ...
    private static BsonArray MapTrangBiItems(IEnumerable<BaoQuanScheduleTrangBiItem> items)
    {
